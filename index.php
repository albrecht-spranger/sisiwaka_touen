...
<head>
	...
	<link
		href="https://fonts.googleapis.com/css2?family=Dela+Gothic+One&family=Hina+Mincho&family=Kaisei+Tokumin&family=M+PLUS+2:wght@100..900&family=Zen+Antique&display=swap"
		rel="stylesheet">
...
<body>
	...
	<main>
		<div class="main_container">
			...
			<div class="about_section">
				...
				<div class="intro_area section_contents">
			...
			<!-- Worksセクション -->
			<a href="works.php" class="art_link"><span>作品一覧へ</span></a>

			<!-- Contactセクション開始 -->
			<a href="https://ss953871.stars.ne.jp/script/mailform/sisiwaka_touen/" class="contact_box">
	...
	<!-- JavaScript -->
	<script src="scripts/top_page.js"></script>
</body>
